      ...
      sectionContent={
        <div>
          <p>
            ...
            angezeigt wird. Die Anzeige der maximalen Wassertiefe wird dabei auf volle 10 cm
          ...
          <p>
            ...
            Sie einen sehr großen Betrachtungsmaßstab ein (Zoomstufe 22). Dann wird Ihnen in der
            Kartendarstellung auch die zu der maximalen Fließgeschwindigkeit gehörende Fließrichtung
            zellenscharf angezeigt.
          </p>
          <p>
            Wenn Sie nach der Abfrage einer maximalen Wassertiefe bzw. Fließgeschwindigkeit eine
            andere Simulation auswählen, wird der angezeigte Zellwert automatisch aktualisiert. So
            können Sie für eine bestimmte Position bequem alle angebotenen Simulations-Szenarien
