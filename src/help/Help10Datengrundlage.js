      ...
      sectionContent={
        <div>
          ...
          <p>
            ...
            <a onClick={() => setAppMenuActiveMenuSection("szenarien")}>simulierte Szenarien</a> an,
            drei "Modellregen" sowie das anhand der Niederschlagsmessungen desselben Tages
            nachgestellte Starkregenereignis vom 29.05.2018.{" "}
          </p>
