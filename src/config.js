...
const config = {
  ...
  simulations: [
    {
      depthLayer: "starkregen:S22_11_T50_depth",
      velocityLayer: "starkregen:S22_11_T50_velocity",
      directionsLayer: "starkregen:S22_11_T50_direction",
    ...
    {
      depthLayer: "starkregen:S22_12_T100_depth",
      velocityLayer: "starkregen:S22_12_T100_velocity",
      directionsLayer: "starkregen:S22_12_T100_direction",
      depthStyle: "starkregen:depth",
      velocityStyle: "starkregen:velocity",
      directionStyle: "starkregen:direction",
      animation: "22_12_T100/",
      name: "Stärke 7",
      icon: "bar-chart",
    ...
    {
      depthLayer: "starkregen:S22_13_hN90mm_depth",
      velocityLayer: "starkregen:S22_13_hN90mm_velocity",
      directionsLayer: "starkregen:S22_13_hN90mm_direction",
      depthStyle: "starkregen:depth",
      velocityStyle: "starkregen:velocity",
      directionStyle: "starkregen:direction",
      animation: "22_13_hN90mm/",
      name: "Stärke 10",
      icon: "bitbucket",
    ...
    {
      depthLayer: "starkregen:S22_14_Naturregen_depth",
      velocityLayer: "starkregen:S22_14_Naturregen_velocity",
      directionsLayer: "starkregen:S22_14_Naturregen_direction",
      depthStyle: "starkregen:depth",
      velocityStyle: "starkregen:velocity",
      directionStyle: "starkregen:direction",
      animation: "22_14_Naturregen/",
      name: "29.05.18",
      icon: "calendar",
